...
class BasePlot:
    def __init__(self, data, colors=None, font='Arial, Helvetica, sans-serif', **kwargs):
        print("Initializing BasePlot...")
        self.data = data
        print(f"Data columns available: {self.data.columns.tolist()}")
        self.colors = {
        ...
        print(f"Identified topic column: {self.topic_column}")
        self.topic_words_column = self.data_preparation.identify_column('BERTopic_Top_Words')
        print(f"Identified topic words column: {self.topic_words_column}")
    ...
    class DataPreparation:
        ...
        def identify_prediction_columns(self):
            ...
            for col in self.data.columns:
                if 'continuous:' in col.lower(): 
                    ...
                    print(f"Added continuous prediction column: {col}")
                elif 'probability distribution' in col.lower():
                    prediction_cols.append(col)
                    print(f"Added probability distribution column: {col}")
            return prediction_cols

        def extract_prediction_info(self, column_name):
            print(f"Extracting prediction info from column name: {column_name}")
            if 'continuous:' in column_name.lower():
                ...
                number = None
            print(f"Extracted prediction_type: {prediction_type}, number: {number}, prediction_word: {prediction_word}")
                ...
                for item in metadata_content:
                    ...
                    for line in lines:
                        ...
                        if ':' in line or '=' in line:
                            ...
                            print(f"Extracted metadata key: '{key}', value: '{value}'")
            else:
        ...
        class TimeHandling:
            def __init__(self, data_preparation_instance, time_column=None):
                print("Initializing TimeHandling...")
                ...
                print(f"Time column for parsing: {self.time_column}")
...
class BERTVisualization(BasePlot):
    ...
    def visualize_topics_over_time(self, top_n_topics=None, topics=None,
        ...
        if topics_list is None:
            print("Fitting BERTopic model to get topics.")
    ...
    def visualize_barchart(self, topics=None, top_n_topics=8, n_words=5,
